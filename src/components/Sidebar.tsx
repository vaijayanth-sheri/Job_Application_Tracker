...
export default function Sidebar() {
      ...
      <div className="relative z-10 flex flex-col h-full">
        ...
        <div className="px-6 py-8">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-[10px] text-indigo-200/70 font-medium tracking-wide">Track · Apply · Land</p>
            </div>
          </div>
        </div>
        ...
        <div className="p-6 pb-8">
          <button
            ...
            disabled={loggingOut}
            className="flex items-center gap-2 text-sm font-medium text-indigo-200/60 hover:text-white transition-colors"
          >
  ...
  return (
    <>
      ...
      <aside
        className={cn(
          'fixed top-0 left-0 z-40 h-screen w-64 flex flex-col overflow-hidden',
          'bg-gradient-to-b from-[#2D2B52] to-[#1E1B4B] shadow-2xl border-r border-white/5',
      ...
      >
        ...
        <button
          onClick={() => setMobileOpen(false)}
          className="absolute top-4 right-4 p-1.5 rounded-lg text-white/60 hover:text-white hover:bg-white/10 lg:hidden z-50"
